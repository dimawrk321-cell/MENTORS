...
function SelectTrigger({
  ...
  return (
    <SelectPrimitive.Trigger
      className={cn(
        "rounded-control border-border text-text-1 inline-flex h-11 w-full min-w-0 items-center justify-between gap-2 overflow-hidden border bg-transparent px-3 text-[14px] md:h-9",
