      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            ...
            цепи.{" "}
            {/* Заход «Банк вопросов» (A4): у категорий нет собственных тумблеров —
                единственный рычаг здесь, и он открывает сразу и вопросы. */}
            <span className="text-text-1">
              Вместе с курсом ученику открываются и его категории банка вопросов
            </span>{" "}
            — в каталоге, в повторениях и в поиске. Отдельных переключателей по категориям нет:
            состав задаётся в редакторе курса.
          </CardDescription>
        </CardHeader>
        <CardContent>
