  ...
  return new ImageResponse(
    <div
      style={{
        ...
        backgroundImage:
          "radial-gradient(900px 500px at 85% -10%, rgba(94,106,210,0.28), transparent)",
      }}
    >
      {/* «P» monogram (13.4/4.5), same indigo gradient + rounded-rect container. */}
      ...
      <div style={{ marginTop: 20, fontSize: 38, fontWeight: 400, color: "#9ba0a8" }}>{SLOGAN}</div>
    </div>,
    {
      ...size,
      fonts: [
