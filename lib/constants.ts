...
export const MOCK_LOCKED_TITLE = "Бронь мока откроется после первого курса";
export const MOCK_LOCKED_TEXT =
  "Мок — это разбор того, что ты уже знаешь. Пройди первый курс целиком (уроки и модульные тесты), и бронирование откроется само.";
/** Тот же смысл строкой для тоста server action (spec 9). */
export const MOCK_LOCKED_MESSAGE =
  "Бронь мока откроется после первого пройденного курса — открой «Обучение»";
